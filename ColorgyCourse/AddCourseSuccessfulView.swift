...
class AddCourseSuccessfulView: UIView {
    ...
    */
    ...
    convenience init() {
        ...
        let successLabel = UILabel(frame: CGRectMake(0, 0, self.bounds.width, 18))
    ...
    func animate(complete: () -> Void) {
        ...
        UIView.animateWithDuration(0.2, delay: 0, usingSpringWithDamping: 0.75, initialSpringVelocity: 0.4, options: [], animations: { () -> Void in
            self.alpha = 1.0
            ...
            if finished {
                ...
                dispatch_after(delay, dispatch_get_main_queue(), { () -> Void in
                    complete()
                    UIView.animateWithDuration(0.15, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.2, options: [], animations: { () -> Void in
